      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="flex flex-col gap-4 md:col-span-2">
          ...
          <p className="text-sm text-text-primary/70 max-w-sm">
            ...
            <br />
            <br />
            Disclaimer: We are not a professional tax firm. Our advice is based
            on training provided by the IRS VITA program.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-sm text-text-primary/70">contact@terptaxumd.org</p>
